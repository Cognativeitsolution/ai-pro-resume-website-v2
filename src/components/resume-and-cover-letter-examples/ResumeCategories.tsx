    ...
    <>
      ...
      <section className="py-5 md:py-10">
        <div className="container">
          {showLoader ? (
            <CustomLoader size={50} color="#9885FF" text="Fetching Resume Examples..." />
          ) : (
                    ...
                    return (
                      <div key={index}>
                        ...
                        {category.resume_examples.length < 4 ? (
                          <StaticTemplates examples={category.resume_examples} exp_img={exp_img} />
                        ) : (
                          <SliderTemplates examples={category.resume_examples} exp_img={exp_img} />
                        )}
                      </div>
                    );
                  })
