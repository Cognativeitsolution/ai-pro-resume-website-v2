...
const BuildATSfriendlyResume = dynamic(
  () => import("./ATS-checker/BuildATSfriendlyResume")
);
const ParsedResumeOverview = dynamic(
  () => import("./ATS-checker/ParsedResumeOverview")
);
