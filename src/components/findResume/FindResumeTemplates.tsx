    ...
    <>
      <section className="py-5 md:py-10">
        <div className={data.fullWidth === true ? "" : "container"}>
          <div className={`${data.fullWidth === true ? "px-8 bg-indigo-200/20 backdrop-blur-none" : "bg-indigo-200/20 backdrop-blur-none border-2 border-white rounded-lg px-4 md:px-0"} py-10`}>
            <div className={data.fullWidth === true ? "container" : ""}>
            ...
            <div className="mt-0 md:mt-5">
              <AutoPlaySlider
                ...
                arrows={data.fullWidth === true ? false : true}
              >
