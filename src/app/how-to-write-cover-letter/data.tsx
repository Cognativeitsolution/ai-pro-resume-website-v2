...
export const BannerData = {
  title: (
    <>
      Your AI Assistant for Job-Winning
      <br className="hidden lg:block" /> Cover Letters
    </>
  ),
  subtitle: "How To Write a Cover Letter",
  description: (
    <>Craft a standout cover letter with AI Pro Resume's expert tips.</>
  ),
};
