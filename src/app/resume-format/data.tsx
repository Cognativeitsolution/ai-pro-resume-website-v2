...
export const BannerData = {
  ...
  description: (
    <>
      The resume format is the first thing a recruiter notices in your resume.
      <br className="hidden lg:block" /> If your format of resume is dull, there
      is a higher chance that you will be rejected.
      <br className="hidden lg:block" />
      You must choose the perfect resume format that suits your profile and job
      role.
    </>
  ),
};
