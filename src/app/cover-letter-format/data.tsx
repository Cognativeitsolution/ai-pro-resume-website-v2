...
export const BannerData = {
  ...
  title: (
    <>
      Easy Cover Letter Formats for Big
      <br className="hidden lg:block" /> Career Moves
    </>
  ),
  subtitle: "Cover Letter Format",
  description: (
    <>
      Craft standout cover letters effortlessly with AI Pro Resume's expert
      guidance.
      <br className="hidden lg:block" /> Explore formats, tips, and examples for
      email and standard cover letters.
    </>
  ),
};
